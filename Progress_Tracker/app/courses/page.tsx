        ...
        {roadmaps.map(roadmap => {
          ...
          return (
            <Link 
              ...
              className="group flex flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-indigo-200 dark:border-gray-800 dark:bg-zinc-950 dark:hover:border-indigo-900/50"
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{roadmap.title}</h2>
              </div>
